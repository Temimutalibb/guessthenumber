...
var correctNumber = document.querySelector(".correct-number");
var correctNumberP = document.querySelector(".correct-number p");
var play = document.querySelector(".play");
var classone = document.querySelectorAll(".one");
...
function checkGame() {
  ...
  var inputValue = Number(inputNumber.value);
...
function gameOver() {
  ...
  var childElements = gameBody.querySelectorAll("*");
...
function resetGame() {
  ...
  win = 0;
  lost = 0;
  var resetChildElements = gameBody.querySelectorAll("*");
  resetChildElements.forEach(function (element) {
  ...
  inputNumber.value = "";
  var childElements = gameDisplay.querySelectorAll("*");
  childElements.forEach(function (element) {
    element.textContent = "";
  });
}
